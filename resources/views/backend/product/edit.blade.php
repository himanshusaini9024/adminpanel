            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Upload button -->
                        <button type="button" id="thumbnail_upload" class="btn btn-primary">
                            Upload Images
                        </button>

                        <!-- Container for multiple inputs -->
                        <div id="image_container" style="margin-top:15px;"></div>
                ...
                <!-- MODAL -->
                <div id="galleryModal_thumbnail"
                    style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:#00000080; z-index:9999;">
                    <div style="background:#fff; margin:50px auto; padding:20px; width:80%;">
                        <h4>Select Image</h4>

                        <div id="galleryImages_thumbnail" style="display:flex; flex-wrap:wrap; gap:10px;"></div>

                        <button onclick="closeGallery_thumbnail()" class="btn btn-danger mt-3">Close</button>
                    </div>
                </div>
